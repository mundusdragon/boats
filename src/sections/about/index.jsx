    ...
    <section className = {`${ s.about } relative`}>
      ...
      <div className = {`flex ${ s.field } relative`}>
        ...
        <h4 className = {`${ s.field__text } relative`}>
          ...
          <br /><br />
          Добро пожаловать в компанию `BOATS GROUP`. Уже более пяти лет мы предоставляем качественные услуги владельцам <br className = "desktop"/>
          ...
          море станет еще более приятным и качественным. Мы гордимся тем, что зарекомендовали себя как надежный сервис <br />
